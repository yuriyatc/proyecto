							...
							<div class="row">
								<div class="col-md-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="dni" placeholder="Numero Documento">
									</div>
								</div>
								<div class="col-md-6">
									<div class="input-group">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="domicilio" placeholder="Direccion">
									</div>
								</div>
								<div class="col-md-6">
									<div class="input-group">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" name="region" placeholder="Barrio">
									</div>
								</div>
							</div>
						</div>
								...
								<div class="col-md-6">
									<div class="input-group">
										...
										<select class="form-control" name="carnet_conducir" placeholder="Carnet de conducir">
											<option value=""disabled selected>Licencia de Conducir</option>
